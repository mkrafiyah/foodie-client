...
const Banner = () => {
    return (
        <div className="hero h-[540px] bg-black-100">
            <div className="hero-content flex-col lg:flex-row-reverse ">
                <img src="https://i.ibb.co/JnwNfVY/banner-food.jpg" className=" w-[450px] h-[450px] rounded-full shadow-2xl " />
                <div className="mr-20">
                    ...
                    <button className="btn bg-amber-400">See All</button>
                </div>
            </div>
        </div>
    );
